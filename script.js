...
(function() {
  var ANIMATION_DURATION, ANIMATION_INTERVAL, APP, App, CIRCLE_SEGMENTS, Decal, HEXAGONS_HIGH, Hexagon, INNER_BUMP_R, INNER_RING_RADIUS, INNER_ZOOM_FACTOR, OUTER_RING_RADIUS, OUTER_ZOOM_FACTOR, RING_WIDTH, SCREEN_RATIO, SMALL_HEXAGONS_HIGH, TAN30, distanceFromCenter,
  ...
  App = (function() {
    ...
    App.prototype.VERTEX = 2;

    App.prototype.FRAGMENT = 3;
    ...
    App.prototype.initGLContext = function() {
    ...
    App.prototype.createNamedShader = function(name, attributes, uniforms) {
    ...
    App.prototype.createVertexAndFaceBuffers = function(name, object, triangleVertexData, triangleFacesData) {
    ...
    App.prototype.initHexagons = function(name, hexagonsHigh, widthToHeight, minR, maxR, zoomFactor) {
      ...
      this.createVertexAndFaceBuffers(name, hexagons, triangleVertexData, triangleFacesData);
      return hexagons;
    };

    App.prototype.initCircleSegments = function(name, segmentCount, radius) {
      ...
      this.createVertexAndFaceBuffers(name, segments, triangleVertexData, triangleFacesData);
      return segments;
    };

    App.prototype.initBackgroundSquare = function(name) {
      var square, triangleFacesData, triangleVertexData;
      square = {};
      triangleVertexData = [-1, -1, 1, -1, 1, 1, -1, 1];
      triangleFacesData = [0, 1, 2, 0, 2, 3];
      this.createVertexAndFaceBuffers(name, square, triangleVertexData, triangleFacesData);
      return square;
    };

    App.prototype.initDecals = function(name, inner) {
      ...
      this.createVertexAndFaceBuffers(name, decals, triangleVertexData, triangleFacesData);
      return decals;
    };
    ...
    App.prototype.initElements = function() {
      ...
      return this.video = document.getElementsByTagName('video')[0];
    };
    ...
    App.prototype.init = function() {
      ...
      try {
        this.initCanvas();
        this.initGLContext();
        if (typeof this.beginInitShaders === "function") {
          this.beginInitShaders();
        }
        ...
        if (typeof this.endInitShaders === "function") {
          this.endInitShaders();
        }
        if (typeof this.beginInitShapes === "function") {
          this.beginInitShapes();
        }
        this.bigHexagons = this.initHexagons('bigHaxagons', HEXAGONS_HIGH, SCREEN_RATIO, OUTER_RING_RADIUS + RING_WIDTH, Infinity, OUTER_ZOOM_FACTOR);
        this.smallHexagons = this.initHexagons('smallHexagons', SMALL_HEXAGONS_HIGH, 1, INNER_RING_RADIUS + RING_WIDTH, OUTER_RING_RADIUS, INNER_ZOOM_FACTOR);
        this.circleSegments = this.initCircleSegments('circleSegments', CIRCLE_SEGMENTS, INNER_RING_RADIUS);
        this.backgroundSquare = this.initBackgroundSquare('backgroundSquare');
        this.innerDecals = this.initDecals('innerDecals', true);
        this.outerDecals = this.initDecals('outerDecals', false);
        if (typeof this.endInitShapes === "function") {
          this.endInitShapes();
        }
        this.initTexture();
        this.initElements();
